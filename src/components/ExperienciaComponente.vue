...
const experiencias = ref([
    { id: 1, src: icono1, parrafo: 'Lideré un equipo de varios desarrolladores traines en unas olimpiadas de programacion que realice junto a 4 amigas mas con el apoyo de Accenture argentina y Eidos Global' },
