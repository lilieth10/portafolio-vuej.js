...
const educacion = ref([
  ...
  {fecha: '2023', title: 'Desarrollador Full Stack', descripcion: 'Aprendi y desarrollé aplicaciones web completas utilizando tecnologías como Node.js, React y MongoDB.', enlace:'https://github.com/lilieth10'},
  {fecha: '2022', title: 'Proyecto Personal - Aplicación de Gestión de Tareas', descripcion: 'Desarrollé una aplicación para la gestión de tareas diarias usando HTML, CSS y JavaScript, implementando funcionalidades como listas de tareas y recordatorios.', enlace:'http:www.direccion.com'},
  {fecha: '2021', title: 'Curso de Introducción a la Programación', descripcion: 'Completé un curso en línea sobre fundamentos de programación, donde aprendí lenguajes como Python y Javascript.', enlace:'http:www.direccion.com'}
]);
</script>
